...
public class DownloadFile {
	...
	private static final String[] APP_WITHOUT_LIFE_CYCLE = {
		"complianceserver-1-a@ny2-lab-001.prod.tradingscreen.com",
		...
		"portfolios-1-a@ny2-lab-001.prod.tradingscreen.com",
		"portfolios-1-b@ny2-lab-002.prod.tradingscreen.com",
		"portfolios-2-a@to1-lab-001.prod.tradingscreen.com",
		"portfolios-2-b@to1-lab-002.prod.tradingscreen.com",
		"portfolios-3-a@hk2-lab-001.prod.tradingscreen.com",
		"portfolios-3-b@hk2-lab-002.prod.tradingscreen.com",
		"portfolios-5-a@pa1-lab-003.prod.tradingscreen.com",
		"portfolios-5-b@pa1-lab-004.prod.tradingscreen.com",
		"possrv-3-a@hk2-lab-001.prod.tradingscreen.com",
		"possrv-3-b@hk2-lab-002.prod.tradingscreen.com",
		"newman-1-a@ny2-lab-001.prod.tradingscreen.com",
		"newman-1-b@ny2-lab-002.prod.tradingscreen.com",
	...
	//private static final String host = "ny2-lia-001.prod.tradingscreen.com"; // PROD machine for wiseguy
	private static final int port = 22;
	
	
	public static void main(String[] args) {
		
		String remote = "/data/versions/wiseguy/log/uatdev/checklog-20191112-174031-cron.log";
		
		//String remote = "/data/versions/wiseguy/log/prod/status-20191108-195145-adhoc.log"; // My MacBook
		String local = "C:\\Users\\wlopes\\IdeaProjects\\slog\\src\\main\\resources\\input\\checklog-20191112-174031-cron.log"; // local windows machine
