...
/**
 * An inclusion/exclusion filterset, similar to ant's fileset but does not
 * support directories in the same style(**, etc).
 * 
 * For example:
 * <ul>
 * <li>/servlet/* matches all urls starting with "/servlet/" e.g.
 * /servlet/this.html
 * <li>*.do matches all urls that end in ".do" - e.g. mypage.do
 * <li>/servlet/*.do matches all urls starting with "/servlet/" and end in ".do"
 * - e.g. /servlet/mypage.do
 * </ul>
 * 
...
public class UrlFilter {
	...
	/**
	 * Checks to see if uri matches at least ONE inclusion filter and doesn't match
