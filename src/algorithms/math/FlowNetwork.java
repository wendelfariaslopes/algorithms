...
public class FlowNetwork {
    ...
    /**
     * Returns the number of vertices in the edge-weighted algorithms.graph.
     * @return the number of vertices in the edge-weighted algorithms.graph
     */
    public int V() {
        return V;
    }
    ...
    /**
     * Returns the number of edges in the edge-weighted algorithms.graph.
     * @return the number of edges in the edge-weighted algorithms.graph
     */
    public int E() {
        return E;
    }
