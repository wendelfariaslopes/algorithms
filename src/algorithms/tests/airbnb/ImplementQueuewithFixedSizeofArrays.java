...
public class ImplementQueuewithFixedSizeofArrays {
	/*
	 * Implement Queue with Fixed Size of Arrays The queue is another data
	 * structure. A physical analogy for a queue is a line at a bank. When you go to
	 * the bank, customers go to the rear (end) of the line and customers come off
	 * of the line (i.e., are serviced) from the front of the line.
	 */
