...
/**
 * The time complexity of binary search is in order of O(logN) if you get the
 * sorted input. If you have to sort the input then you need to add that time on
 * the total run time of the algorithm as well.
 * 
 * @author wendellopes
 *
 */
