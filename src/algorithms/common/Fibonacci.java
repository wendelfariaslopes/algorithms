...
//        }
      ...
      //comparison of performance of Fibonacci number with memoization
        ...
        System.out.println("Time taken to calculate Fibonacci number upto 100M without memorization:" + elapsedTime1);
              
        startTime = System.nanoTime();
        result = improvedFibo(number); //Fibonacci number with memoization
        long elapsedTime2 = System.nanoTime() - startTime;
        System.out.println("Time taken to calculate Fibonacci number upto 100M with memorization:" + elapsedTime2);
        System.out.println("Memorization quicky times:" + ((double)elapsedTime1/(double)elapsedTime2));
