...
public class NN2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Input size training data "+X.length+ " samples.");
        System.out.println("Output size training data "+Y.length+ " are False samples.");
        System.out.println("Actual (Expected) = "+Y.length+ " are True samples.");
