package cogito4j.data.preprocessing;
...
public class EdgeDetector {
	...
	public static final String DIR="../algorithms/src/cogito4j/data/preprocessing/";
    ...
    public static void main(String[] args) {
      ...
      //  String nameFile = "cat_1.jpg";
        
        String nameFile = "img_1.jpg";
        
        Picture picture0 = new Picture(DIR + nameFile);
